...
# Compatibility patch: flash_attn imports removed to satisfy check_imports without installing
# flash-attn. Florence2FlashAttention2 is unreachable when attn_implementation != "flash_attention_2".
...
# Compatibility patch: second flash_attn import block removed for the same reason.
